...
const TW_CATALOG = [
  ...
  /* ========== ENGINEERING — GRANDES ÉCOLES ========== */
  {
    ...
    avgHistory: [{ uni: 'ESI-SBA · سيدي بلعباس', y2024: 13.20, y2025: 13.50 }],
    unis: [{ abbr: 'ESI-SBA', name: 'المدرسة العليا في الإعلام الآلي', location: 'سيدي بلعباس', avg: 13.50 }],
