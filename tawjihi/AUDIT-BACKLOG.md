# Tawjihi — Director's Audit Backlog
**Generated:** 2026-06-23 | **Source:** 6-agent specialist audit (UI/UX, Web Dev, AI, Data Science, Motion, Responsive)
**Worktree:** `C:\Users\AZ\Documents\BAC CHANNEL\Bac-Story-Website\.claude\worktrees\cool-stonebraker-deb446\`
...
| Agent | ID | Domain | Files Owned |
|-------|-----|--------|-------------|
| A01 | catalog-data-fix | Data | catalog.js |
| A02 | eligibility-data-fix | Data | eligibility.js, data/catalog-eligibility.json |
| A03 | kb-id-normalize | Data/AI | data/kb/specialities-kb.json |
| A04 | chat-api-overhaul | Security/AI | api/tawjihi-chat.js |
| A05 | referral-atomic-fix | Security | api/tawjihi-referral.js |
| A06 | api-auth-validation | Security | api/tawjihi-search.js, api/tawjihi-wishlist.js |
| A07 | vercel-cors-config | Security | vercel.json |
| A08 | tokens-design-system | UI | styles/tokens.css |
| A09 | app-js-ai-ux | AI/UX | app.js |
| A10 | dashboard-overhaul | UI/Motion | dashboard.html, styles/dashboard*.css |
| A11 | chat-page-layout | UI/Responsive | app.html, styles/app.css |
| A12 | shell-auth-motion | Auth/Motion | shell.js |
| A13 | simulator-mobile-ux | UI/Responsive | simulator.html, simulator.js, styles/simulator.css |
| A14 | landing-responsive | UI/Responsive | index.html, styles/landing.css |
| A15 | onboarding-ux-motion | UI/Motion | onboarding.html, onboarding.js, styles/onboarding.css |
| A16 | specialities-browser-fix | UI/RTL | specialities.html, speciality.html, styles/specialities.css, styles/spec-browser.css |
| A17 | auth-login-ui | UI | login.html, styles/auth.css |
| A18 | motion-global-css | Motion | styles/motion.css (NEW) |
| A19 | chat-rich-motion | Motion | styles/chat-rich.css |
| A20 | averages-transport-fix | Data | averages-transport.js |
| A21 | new-pages | UI | privacy.html (NEW), terms.html (NEW) |
| A22 | skeleton-screens | UI/Motion | styles/skeleton.css (NEW) |
