...
function setupSearch() {
    ...
    const navSearchData = [
        ...
        { title: 'النظام الجامعي الجزائري', desc: 'كل ما تحتاج معرفته عن نظام LMD والجامعة', url: '/university#university-system', icon: 'fas fa-university', specialty: null, keywords: ['النظام الجامعي', 'LMD', 'nظام lmd', 'ليسانس ماستر دكتوراه', 'الجامعة الجزائرية', 'نظام الجامعة'] },
        ...
        { title: 'تخصصات الجامعة والمدارس', desc: 'تعريف كامل بجميع التخصصات الجامعية', url: '/university#university-section', icon: 'fas fa-graduation-cap', specialty: null, keywords: ['تخصصات', 'تخصص جامعي', 'مدارس عليا', 'اختيار تخصص', 'توجيه جامعي', 'جامعة', 'LMD', 'ESTIN', 'ESI', 'ENSIA'] },
        ...
        { title: 'ESTIN بجاية', desc: 'ذكاء اصطناعي، أمن سيبراني وإنترنت الأشياء', url: '/university#ESTIN', icon: 'fas fa-robot', specialty: 'مدارس عليا', keywords: ['ESTIN', 'estin', 'بجاية', 'ذكاء اصطناعي', 'أمن سيبراني', 'cybersécurité', 'intelligence artificielle', 'iot', 'génie informatique', 'رقمنة', 'machine learning'] },
        { title: 'ESI الجزائر', desc: 'المدرسة العليا للإعلام الآلي — بن عكنون', url: '/university#ESI-ALGER', icon: 'fas fa-laptop-code', specialty: 'مدارس عليا', keywords: ['ESI', 'esi', 'ISI', 'SIW', 'IRS', 'HCD', 'إعلام آلي', 'génie logiciel', 'سيبراني', 'بن عكنون', 'شبكات'] },
        { title: 'ESI-SBA سيدي بلعباس', desc: 'ذكاء اصطناعي، علوم البيانات ومعمارية الحاسوب', url: '/university#ESI-SBA', icon: 'fas fa-laptop-code', specialty: 'مدارس عليا', keywords: ['ESI-SBA', 'esi sba', 'سيدي بلعباس', 'IASD', 'CYS', 'data science', 'علوم بيانات', 'machine learning', 'وهران'] },
        { title: 'ENSIA — الذكاء الاصطناعي', desc: 'المدرسة الوطنية العليا للذكاء الاصطناعي', url: '/university#ENSIA', icon: 'fas fa-brain', specialty: 'مدارس عليا', keywords: ['ENSIA', 'ensia', 'ذكاء اصطناعي', 'intelligence artificielle', 'machine learning', 'deep learning', 'neural networks', 'big data', 'AI'] },
        { title: 'ENSCS — الأمن السيبراني', desc: 'المدرسة الوطنية العليا للأمن السيبراني', url: '/university#ENSCS', icon: 'fas fa-shield-alt', specialty: 'مدارس عليا', keywords: ['ENSCS', 'enscs', 'cybersécurité', 'سيبراني', 'pentest', 'أمن معلومات', 'ethical hacking', 'أمن شبكات', 'cybersecurity'] },
        { title: 'Polytechnique الجزائر', desc: 'المعهد الوطني البوليتكنيكي — متعدد التخصصات', url: '/university#POLYTECH', icon: 'fas fa-cogs', specialty: 'مدارس عليا', keywords: ['Polytech', 'polytechnique', 'هندسة مدنية', 'ميكانيك', 'كهربائية', 'كيميائية', 'multidisciplinaire', 'بوليتكنيك'] },
        { title: 'NHSM — الرياضيات', desc: 'المدرسة الوطنية العليا للرياضيات', url: '/university#NHSM', icon: 'fas fa-square-root-alt', specialty: 'مدارس عليا', keywords: ['NHSM', 'nhsm', 'رياضيات بحتة', 'mathématiques', 'statistiques', 'probabilités', 'الكوليا', 'analyse', 'algèbre'] },
        { title: 'EPAU — هندسة معمارية', desc: 'المدرسة البوليتكنيكية لهندسة البناء والتعمير', url: '/university#EPAU', icon: 'fas fa-drafting-compass', specialty: 'مدارس عليا', keywords: ['EPAU', 'epau', 'معمارية', 'architecture', 'urbanisme', 'هندسة', 'تعمير', 'بوليتكنيكية'] },
        { title: 'ENSTP — أشغال عمومية', desc: 'المدرسة الوطنية العليا للأشغال العمومية', url: '/university#ENSTP', icon: 'fas fa-hard-hat', specialty: 'مدارس عليا', keywords: ['ENSTP', 'enstp', 'أشغال عمومية', 'travaux publics', 'génie civil', 'VRD', 'routes', 'ponts', 'بناء'] },
        { title: 'IGEE — الكهرباء بومرداس', desc: 'معهد الهندسة الكهربائية والإلكترونيك', url: '/university#IGEE', icon: 'fas fa-bolt', specialty: 'مدارس عليا', keywords: ['IGEE', 'igee', 'هندسة كهربائية', 'génie électrique', 'إلكترونيك', 'طاقة', 'أتوماتيك', 'بومرداس'] },
        ...
        { title: 'AERONAUTIQUE — الطيران', desc: 'المدرسة الوطنية للطيران المدني — البليدة', url: '/university#AERONAUTIQUE', icon: 'fas fa-plane', specialty: 'مدارس عليا', keywords: ['طيران', 'aéronautique', 'aerospace', 'aviation', 'pilot', 'طيار', 'فضاء', 'البليدة', 'صواريخ'] },
        { title: 'ENSH — هيدروليك', desc: 'المدرسة الوطنية العليا للهيدروليك — البليدة', url: '/university#ENSH', icon: 'fas fa-tint', specialty: 'مدارس عليا', keywords: ['ENSH', 'ensh', 'هيدروليك', 'hydraulique', 'ماء', 'سدود', 'ري', 'البليدة', 'ressources en eau'] },
        { title: 'ENSB — البيوتكنولوجيا', desc: 'المدرسة الوطنية العليا للبيوتكنولوجيا', url: '/university#ENSB', icon: 'fas fa-dna', specialty: 'مدارس عليا', keywords: ['ENSB', 'ensb', 'بيوتكنولوجيا', 'biotechnologie', 'biologie moléculaire', 'génétique', 'بيولوجيا جزيئية'] },
        { title: 'EHEC — التجارة', desc: 'المدرسة العليا للتجارة — تيجلابين', url: '/university#EHEC', icon: 'fas fa-chart-line', specialty: 'مدارس عليا', keywords: ['EHEC', 'ehec', 'تجارة', 'commerce', 'marketing', 'management', 'مناجمنت', 'تيجلابين', 'MBA', 'اقتصاد'] },
        { title: 'ENSC — التجارة وهران', desc: 'المدرسة الوطنية العليا للتجارة', url: '/university#ENSC', icon: 'fas fa-chart-line', specialty: 'مدارس عليا', keywords: ['ENSC', 'ensc', 'تجارة', 'وهران', 'commerce', 'marketing', 'sciences commerciales'] },
        { title: 'ESB — البنوك', desc: 'المدرسة العليا للبنوك', url: '/university#ESB', icon: 'fas fa-university', specialty: 'مدارس عليا', keywords: ['ESB', 'esb', 'بنوك', 'بنك', 'banque', 'finance', 'صيرفة', 'إسلامية', 'مالية'] },
        { title: 'ENS — تكوين الأساتذة', desc: 'المدرسة العليا للأساتذة — التكوين التربوي', url: '/university#ENS', icon: 'fas fa-chalkboard-teacher', specialty: 'مدارس عليا', keywords: ['أساتذة', 'ENS', 'ens', 'تعليم', 'تربية', 'enseignement', 'professeur', 'pédagogie', 'école normale', 'أستاذ'] },
        { title: 'ENSA — الزراعة', desc: 'المدرسة الوطنية العليا للزراعة — الجزائر', url: '/university#ENSA', icon: 'fas fa-leaf', specialty: 'مدارس عليا', keywords: ['زراعة', 'agronomie', 'agriculture', 'ENSA', 'ensa', 'فلاحة', 'zootechnie', 'علوم زراعية'] },
        { title: 'ENST — السياحة والفندقة', desc: 'المدرسة الوطنية العليا للسياحة', url: '/university#ENST', icon: 'fas fa-hotel', specialty: 'مدارس عليا', keywords: ['سياحة', 'tourisme', 'فندقة', 'hôtellerie', 'restauration', 'guide touristique', 'voyage', 'ENST', 'enst'] },
        { title: 'ENSSMAL — علوم البحر', desc: 'المدرسة الوطنية العليا للعلوم البحرية', url: '/university#ENSSMAL', icon: 'fas fa-water', specialty: 'مدارس عليا', keywords: ['ENSSMAL', 'بحر', 'marine', 'halieutique', 'océanographie', 'pêche', 'علوم بحرية', 'بيولوجيا بحرية'] },
        { title: 'NHSAST — أنظمة مستقلة', desc: 'المدرسة العليا للأنظمة المستقلة — روبوتيك، درون، أنظمة مدمجة', url: '/university#ENSAS', icon: 'fas fa-robot', specialty: 'مدارس عليا', keywords: ['NHSAST', 'ENSAS', 'nhsast', 'ensas', 'أنظمة مستقلة', 'autonomous systems', 'روبوتيك', 'robotique', 'درون', 'drone', 'UAV', 'ذكاء اصطناعي', 'إلكترونيك', 'برمجة مدمجة', 'embedded', 'سيدي عبد الله', 'national higher school autonomous'] },

        // ── UNIVERSITY TRACKS (LMD) ────────────────────────────────────────
        { title: 'طب عام — كلية الطب', desc: 'الدراسات الطبية الكاملة — الطريق للدكتوراه', url: '/university#MEDCINE', icon: 'fas fa-stethoscope', specialty: 'طب وصحة', keywords: ['طب', 'médecine', 'طبيب', 'CHU', 'doctor', 'دكتور', 'حكيم', 'كلية الطب', 'résidanat', 'طب عام', 'تخصص طبي'] },
        { title: 'طب الأسنان', desc: 'دراسة طب وجراحة الأسنان', url: '/university#MEDCINE-DENTAIRE', icon: 'fas fa-tooth', specialty: 'طب وصحة', keywords: ['طب أسنان', 'dentaire', 'dentiste', 'أسنان', 'orthodontie', 'chirurgie dentaire', 'طب الفم'] },
        { title: 'الصيدلة', desc: 'دراسة الصيدلة والعلوم الصيدلانية', url: '/university#PHARMACIE', icon: 'fas fa-pills', specialty: 'طب وصحة', keywords: ['صيدلة', 'pharmacie', 'صيدلاني', 'دواء', 'médicaments', 'officine', 'pharmacologie', 'pharmacy'] },
        { title: 'شبه طبي', desc: 'تمريض، كينيزيتيرابيا، مخبر، راديولوجيا', url: '/university#PARAMEDICAL', icon: 'fas fa-heartbeat', specialty: 'طب وصحة', keywords: ['شبه طبي', 'infirmier', 'تمريض', 'kinésithérapie', 'كينيزيتيرابيا', 'مخبر', 'labo', 'radiologie', 'أشعة', 'paramedical', 'ممرض'] },
        { title: 'القابلة — توليد', desc: 'تكوين القابلات وصحة الأمومة', url: '/university#Sage-Femme', icon: 'fas fa-baby', specialty: 'طب وصحة', keywords: ['قابلة', 'توليد', 'ولادة', 'sage-femme', 'maïeutique', 'obstétrique', 'أمومة'] },
        { title: 'ليسانس إعلام آلي', desc: 'تخصص الإعلام الآلي بالجامعات LMD', url: '/university#INFORMATIQUE', icon: 'fas fa-code', specialty: 'جامعة LMD', keywords: ['إعلام آلي', 'informatique', 'ليسانس', 'licence', 'génie logiciel', 'réseaux', 'cybersécurité', 'python', 'java', 'web', 'برمجة', 'تطوير'] },
        { title: 'هندسة معمارية LMD', desc: 'الليسانس والماستر في العمارة', url: '/university#ARCHITECTURE-UNI', icon: 'fas fa-building', specialty: 'جامعة LMD', keywords: ['معمارية', 'architecture', 'lmd', 'تعمير', 'urbanisme', 'هندسة بناء', 'بناء'] },
        { title: 'رياضيات — ليسانس', desc: 'الليسانس في الرياضيات والإحصاء', url: '/university#MATH', icon: 'fas fa-infinity', specialty: 'جامعة LMD', keywords: ['رياضيات بحتة', 'mathématiques', 'ليسانس رياضيات', 'statistiques', 'analyse', 'algèbre'] },
        { title: 'علوم الفيزياء والكيمياء', desc: 'تخصص علوم المادة في الجامعات', url: '/university#SM', icon: 'fas fa-atom', specialty: 'جامعة LMD', keywords: ['فيزياء', 'كيمياء', 'sciences de la matière', 'physique', 'chimie', 'SM', 'thermodynamique', 'علوم مادة'] },
        { title: 'بيولوجيا — ليسانس', desc: 'الليسانس في البيولوجيا والبيئة', url: '/university#BIOLOGIE', icon: 'fas fa-leaf', specialty: 'جامعة LMD', keywords: ['بيولوجيا', 'biologie', 'écologie', 'environnement', 'génétique', 'microbiologie', 'علوم طبيعية'] },
        { title: 'الهندسة المدنية', desc: 'تخصص هندسة الإنشاء والبناء', url: '/university#GC', icon: 'fas fa-hard-hat', specialty: 'جامعة LMD', keywords: ['هندسة مدنية', 'génie civil', 'GC', 'بناء', 'بتون', 'VRD', 'هندسة إنشاء', 'géotechnique'] },
        { title: 'الهندسة الميكانيكية', desc: 'تخصص ميكانيك وميكاترونيك', url: '/university#GMEC', icon: 'fas fa-cog', specialty: 'جامعة LMD', keywords: ['هندسة ميكانيكية', 'génie mécanique', 'GMEC', 'ميكانيك', 'machines', 'thermodynamique', 'ميكاترونيك'] },
        { title: 'النفط والغاز', desc: 'هندسة البترول والمحروقات', url: '/university#HYDROCARBURES', icon: 'fas fa-oil-can', specialty: 'جامعة LMD', keywords: ['نفط', 'غاز', 'بترول', 'sonatrach', 'pétrole', 'HYDROCARBURES', 'محروقات', 'raffinerie', 'pétrolier'] },
        { title: 'الحقوق والقانون', desc: 'ليسانس في الحقوق والعلوم القانونية', url: '/university#DROIT', icon: 'fas fa-gavel', specialty: 'جامعة LMD', keywords: ['حقوق', 'قانون', 'droit', 'محاماة', 'قضاء', 'justice', 'commercial', 'avocat', 'juriste'] },
        { title: 'القانون الجنائي والعلوم الجنائية', desc: 'ماستر جنائي — محاماة، قضاء، إجرام وجرائم مستحدثة', url: '/university#PENAL', icon: 'fas fa-balance-scale', specialty: 'جامعة LMD', keywords: ['جنائي', 'قانون جنائي', 'droit pénal', 'PENAL', 'إجرام', 'criminologie', 'جنايات', 'محاماة', 'قاضي', 'وكيل جمهورية', 'cybercrime', 'جرائم إلكترونية', 'ESM'] },
        { title: 'علم الإجرام والسياسة الجنائية', desc: 'ماستر criminologie — تحليل جنائي، سياسة وقاية، تأهيل ومؤسسات عقابية', url: '/university#CRIMINOLOGIE', icon: 'fas fa-user-secret', specialty: 'جامعة LMD', keywords: ['علم إجرام', 'criminologie', 'CRIMINOLOGIE', 'سياسة جنائية', 'علم نفس جنائي', 'علم اجتماع جنائي', 'victimologie', 'علم ضحية', 'مؤسسات عقابية', 'سجون', 'تحليل جنائي', 'أمن وطني', 'درك'] },
        { title: 'الأدلة الجنائية والشرطة العلمية', desc: 'مسار المخبر الجنائي — DNA، بصمات، balistique، أدلة رقمية، INCC', url: '/university#FORENSIQUE', icon: 'fas fa-microscope', specialty: 'أمن وطني / درك', keywords: ['شرطة علمية', 'أدلة جنائية', 'FORENSIQUE', 'police scientifique', 'sciences forensiques', 'DNA', 'بصمات', 'مسرح جريمة', 'balistique', 'INCC', 'بوشاوي', 'مخبر جنائي', 'تزوير وثائق', 'جريمة إلكترونية رقمية'] },
        { title: 'الأكاديمية العسكرية بشرشال', desc: 'EMIA شرشال — ضابط مهندس، هندسة تقنية + تكوين عسكري، مضمون في الجيش', url: '/university#CHERCHALL', icon: 'fas fa-shield-alt', specialty: 'وزارة الدفاع الوطني', keywords: ['شرشال', 'CHERCHALL', 'EMIA', 'أكاديمية عسكرية', 'académie militaire', 'ضابط مهندس', 'جيش وطني شعبي', 'وزارة دفاع', 'mdn', 'دفاع', 'تكوين عسكري', 'هندسة عسكرية', 'بكالوريا رياضيات عسكري'] },
        { title: 'العلوم الاجتماعية', desc: 'علم النفس، علم الاجتماع والأنثروبولوجيا', url: '/university#SS', icon: 'fas fa-users', specialty: 'جامعة LMD', keywords: ['علم نفس', 'علم اجتماع', 'psychologie', 'sociologie', 'SS', 'anthropologie', 'اجتماع', 'نفس'] },
        { title: 'الفلسفة', desc: 'تخصص الفلسفة العامة — منطق، إبستمولوجيا، نقد وحِجاج', url: '/university#PHILO', icon: 'fas fa-brain', specialty: 'جامعة LMD', keywords: ['فلسفة', 'philosophie', 'PHILO', 'منطق', 'إبستمولوجيا', 'نقد', 'حجاج', 'ENS فلسفة', 'فلسفة جامعة', 'أستاذ فلسفة'] },
        { title: 'الإعلام والصحافة', desc: 'علوم الإعلام والاتصال والصحافة', url: '/university#COMMU', icon: 'fas fa-newspaper', specialty: 'جامعة LMD', keywords: ['إعلام', 'صحافة', 'journalisme', 'communication', 'médias', 'relations publiques', 'اتصال', 'COMMU'] },
        { title: 'الترجمة', desc: 'تخصص الترجمة التحريرية والفورية', url: '/university#TRADUCTION', icon: 'fas fa-language', specialty: 'جامعة LMD', keywords: ['ترجمة', 'traduction', 'interprétation', 'لغات', 'فورية', 'تحريرية', 'TRADUCTION'] },
        { title: 'العلوم الإسلامية — جامعة', desc: 'الشريعة والفقه والعلوم الإسلامية', url: '/university#CHARIA', icon: 'fas fa-mosque', specialty: 'جامعة LMD', keywords: ['شريعة', 'فقه', 'حديث', 'قرآن', 'CHARIA', 'إسلامية', 'علوم دينية', 'aqida', 'usoul'] },
        { title: 'علوم سياسية ودبلوماسية', desc: 'العلاقات الدولية والإدارة العامة', url: '/university#SCIENCES-PO', icon: 'fas fa-globe', specialty: 'جامعة LMD', keywords: ['علوم سياسية', 'دبلوماسية', 'relations internationales', 'administration publique', 'SCIENCES-PO', 'دبلوماسي', 'سياسة'] },
        { title: 'تاريخ وجغرافيا — جامعة', desc: 'الليسانس في التاريخ والجغرافيا والآثار', url: '/university#SCIENCES-HUM', icon: 'fas fa-landmark', specialty: 'جامعة LMD', keywords: ['تاريخ', 'جغرافيا', 'آثار', 'تراث', 'histoire', 'géographie', 'archéologie', 'SCIENCES-HUM'] },

        // ── ÉCOLES SUPÉRIEURES SPÉCIALISÉES ──────────────────────────────────
        { title: 'ENA — الإدارة', desc: 'المدرسة الوطنية للإدارة — حيدرة — تكوين الإطارات السامية', url: '/university#ENA', icon: 'fas fa-landmark', specialty: 'مدارس عليا', keywords: ['ENA', 'ena', 'إدارة عامة', 'administration publique', 'حوكمة', 'وزارة', 'والي', 'إطارات دولة', 'fonctionnaire', 'حيدرة', 'مسابقة إدارة', 'الوظيف العمومي'] },
        { title: 'المدرسة العليا للقضاء — ESM', desc: 'تكوين القضاة والمدعين العامين — القليعة', url: '/university#ESM-JUSTICE', icon: 'fas fa-gavel', specialty: 'مدارس عليا', keywords: ['قضاء', 'قاضي', 'magistrature', 'محكمة', 'ESM', 'المدرسة العليا للقضاء', 'وكيل جمهورية', 'حكم', 'القليعة', 'وزارة العدل', 'justice', 'مسابقة قضاء'] },
        { title: 'ESSS — الضمان الاجتماعي', desc: 'المدرسة العليا للضمان الاجتماعي — بن عكنون — شراكة BIT/ILO', url: '/university#ESSS', icon: 'fas fa-hand-holding-heart', specialty: 'مدارس عليا', keywords: ['ESSS', 'esss', 'ضمان اجتماعي', 'sécurité sociale', 'CNAS', 'CASNOS', 'BIT', 'ILO', 'حماية اجتماعية', 'تأمين', 'بن عكنون', 'travail'] },
        { title: 'ENMAS — إدارة الصحة', desc: 'المدرسة العليا للمناجمنت وإدارة الصحة — برج البحري', url: '/university#ENMAS', icon: 'fas fa-hospital', specialty: 'مدارس عليا', keywords: ['ENMAS', 'enmas', 'إدارة صحة', 'management hospitalier', 'مستشفى', 'مدير مستشفى', 'صحة عامة', 'برج البحري', 'وزارة الصحة', 'hôpital'] },
        { title: 'IEDF — الجباية والجمارك', desc: 'معهد الاقتصاد الجبائي والجمركي — القليعة — مشترك جزائري تونسي', url: '/university#IEDF', icon: 'fas fa-receipt', specialty: 'مدارس عليا', keywords: ['IEDF', 'iedf', 'جباية', 'جمارك', 'fiscalité', 'douane', 'ضرائب', 'TVA', 'مفتش ضرائب', 'التجارة الخارجية', 'القليعة', 'مالية', 'impôts'] },
        { title: 'IDRI — الدبلوماسية', desc: 'معهد الدبلوماسية والعلاقات الدولية — بن عكنون — وزارة الخارجية', url: '/university#IDRI', icon: 'fas fa-globe-africa', specialty: 'مدارس عليا', keywords: ['IDRI', 'idri', 'دبلوماسية', 'علاقات دولية', 'سفير', 'دبلوماسي', 'وزارة الخارجية', 'MAE', 'سفارة', 'diplomatie', 'relations internationales', 'بن عكنون'] },
        { title: 'ESSP — العلوم السياسية', desc: 'المدرسة العليا للعلوم السياسية — بن عكنون — دراسات استراتيجية', url: '/university#ESSP', icon: 'fas fa-vote-yea', specialty: 'مدارس عليا', keywords: ['ESSP', 'essp', 'علوم سياسية', 'sciences politiques', 'دراسات استراتيجية', 'جيوسياسية', 'تحليل سياسي', 'بن عكنون', 'أمن', 'géopolitique'] },
        { title: 'ENSJSI — الصحافة والإعلام', desc: 'المدرسة الوطنية العليا للصحافة وعلوم الإعلام — بن عكنون', url: '/university#ENSJSI', icon: 'fas fa-newspaper', specialty: 'مدارس عليا', keywords: ['ENSJSI', 'ensjsi', 'صحافة', 'إعلام', 'journalisme', 'télévision', 'radio', 'reportage', 'صحفي', 'اتصال', 'médias', 'بودكاست', 'بن عكنون', 'تلفزيون'] },

        // ── اللغات الأجنبية – تخصصات فردية ──
        { title: 'ليسانس الإنجليزية – Anglais', desc: 'تخصص اللغة الإنجليزية — ترجمة، تدريس، شركات دولية، freelance', url: '/university#ANGLAIS', icon: 'fas fa-language', specialty: 'لغات أجنبية', keywords: ['anglais', 'إنجليزية', 'اللغة الإنجليزية', 'ليسانس إنجليزية', 'english', 'ESP', 'ترجمة إنجليزية', 'Fulbright', 'فريلانس', 'Fiverr', 'شركات دولية', 'ENS', 'phonetics', 'linguistics'] },
        { title: 'ليسانس الفرنسية – Français', desc: 'تخصص اللغة الفرنسية — أدب، إدارة، تعليم، صحافة', url: '/university#FRANCAIS', icon: 'fas fa-language', specialty: 'لغات أجنبية', keywords: ['français', 'فرنسية', 'اللغة الفرنسية', 'ليسانس فرنسية', 'littérature française', 'didactique', 'FLE', 'إدارة', 'صحافة', 'بنوك', 'grammaire', 'linguistique'] },
        { title: 'ليسانس الإسبانية – Espagnol', desc: 'تخصص اللغة الإسبانية — سياحة، استيراد تصدير، أمريكا لاتينية', url: '/university#ESPAGNOL', icon: 'fas fa-language', specialty: 'لغات أجنبية', keywords: ['espagnol', 'إسبانية', 'اللغة الإسبانية', 'ليسانس إسبانية', 'español', 'أمريكا لاتينية', 'سياحة', 'استيراد تصدير', 'ترجمة إسبانية', 'البليدة 2', 'وهران 2', 'قسنطينة 1', 'تلمسان', 'gramática'] },
        { title: 'ليسانس الألمانية – Allemand', desc: 'تخصص اللغة الألمانية — Ausbildung ألمانيا، شركات ألمانية، Goethe-Institut', url: '/university#ALLEMAND', icon: 'fas fa-language', specialty: 'لغات أجنبية', keywords: ['allemand', 'ألمانية', 'اللغة الألمانية', 'ليسانس ألمانية', 'Deutsch', 'Ausbildung', 'هجرة ألمانيا', 'Goethe-Institut', 'Siemens', 'BASF', 'Volkswagen', 'شركات ألمانية', 'Grammatik'] },
        { title: 'ليسانس الإيطالية – Italien', desc: 'تخصص اللغة الإيطالية — ENI، شراكة جزائرية إيطالية، ترجمة طاقة', url: '/university#ITALIEN', icon: 'fas fa-language', specialty: 'لغات أجنبية', keywords: ['italien', 'إيطالية', 'اللغة الإيطالية', 'ليسانس إيطالية', 'italiano', 'ENI', 'Saipem', 'Mattei Plan', 'طاقة إيطالية', 'ترجمة إيطالية', 'البليدة 2', 'Dante', 'Boccaccio'] },
        { title: 'ليسانس الروسية – Russe', desc: 'تخصص اللغة الروسية — دبلوماسية، Sonatrach-Gazprom، منح روسيا', url: '/university#RUSSE', icon: 'fas fa-language', specialty: 'لغات أجنبية', keywords: ['russe', 'روسية', 'اللغة الروسية', 'ليسانس روسية', 'Gazprom', 'Sonatrach', 'سفارة روسيا', 'منح روسيا', 'دبلوماسية', 'قسم اللغات الشرقية', 'Dostoevsky', 'Tolstoy', 'سيريلية'] },
        { title: 'ليسانس التركية – Turc', desc: 'تخصص اللغة التركية — Tosyali، Tayal، شركات تركية، أعلى توظيف', url: '/university#TURC', icon: 'fas fa-language', specialty: 'لغات أجنبية', keywords: ['turc', 'تركية', 'اللغة التركية', 'ليسانس تركية', 'Türkçe', 'Tosyali', 'Tayal', 'شركات تركية', 'يونس إمرة', 'Yunus Emre', 'استثمار تركي', 'سفارة تركيا', 'vowel harmony'] },
        { title: 'ليسانس الصينية – Chinois', desc: 'تخصص اللغة الصينية — Huawei، ZTE، موانئ، ترجمة دولة، منح الصين', url: '/university#CHINOIS', icon: 'fas fa-language', specialty: 'لغات أجنبية', keywords: ['chinois', 'صينية', 'اللغة الصينية', 'ليسانس صينية', 'Huawei', 'ZTE', 'COSCO', 'ميناء الحمدانية', 'منح الصين', 'Confucius', 'كونفوشيوس', 'HSK', 'Hanzi', 'Pinyin', 'ترجمة صينية'] },

        // ── ESAA ──
        { title: 'ESAA — إدارة الأعمال', desc: 'المدرسة العليا الجزائرية للأعمال — المحمدية — شهادة مزدوجة جزائرية فرنسية', url: '/university#ESAA', icon: 'fas fa-briefcase', specialty: 'مدارس عليا', keywords: ['ESAA', 'esaa', 'إدارة أعمال', 'تسيير', 'مالية', 'تسويق', 'شهادة مزدوجة', 'double diplôme', 'Kedge', 'Audencia', 'BNP Paribas', 'Big Four', 'KPMG', 'EY', 'TAGE', 'المحمدية', 'شراكة فرنسية', 'ريادة أعمال', 'محاسبة', 'Schneider', 'Unilever'] },

        // ── تخصصات اقتصاد وتسيير الجامعية ──
        { title: 'العلوم الاقتصادية – Sciences Éco', desc: 'تخصص اقتصاد كلي وجزئي — بنوك، وزارة المالية، مراكز بحوث', url: '/university#ECO', icon: 'fas fa-chart-line', specialty: 'اقتصاد وتسيير', keywords: ['علوم اقتصادية', 'اقتصاد', 'sciences économiques', 'microéconomie', 'macroéconomie', 'اقتصاد كلي', 'اقتصاد جزئي', 'اقتصاد نقدي', 'بنوك', 'بنك مركزي', 'سياسة نقدية', 'تضخم', 'وزارة المالية', 'SEGC', 'تحليل اقتصادي', 'اقتصاد دولي'] },
        { title: 'علوم التسيير – Sciences de Gestion', desc: 'تخصص إدارة وتسيير — محاسبة، موارد بشرية، تدقيق، مراقبة', url: '/university#GESTION', icon: 'fas fa-cogs', specialty: 'اقتصاد وتسيير', keywords: ['علوم التسيير', 'تسيير', 'sciences de gestion', 'management', 'محاسبة', 'comptabilité', 'موارد بشرية', 'GRH', 'تدقيق', 'audit', 'مراقبة التسيير', 'contrôle de gestion', 'مالية', 'CFO', 'ERP', 'SEGC', 'إدارة أعمال'] },
        { title: 'العلوم التجارية – Sciences Commerciales', desc: 'تخصص تسويق وتجارة دولية — لوجيستيك، استيراد تصدير، E-Commerce', url: '/university#COMMERCE', icon: 'fas fa-store', specialty: 'اقتصاد وتسيير', keywords: ['علوم تجارية', 'تجارية', 'sciences commerciales', 'تسويق', 'marketing', 'تجارة دولية', 'commerce international', 'لوجيستيك', 'supply chain', 'استيراد تصدير', 'import export', 'جمارك', 'e-commerce', 'تسويق رقمي', 'digital marketing', 'SEGC'] },

        // ── المدرسة العليا للضرائب ──
        { title: 'المدرسة العليا للضرائب – ESI قليعة', desc: 'مدرسة عليا للجباية والمالية العامة — دخول بعد Bac+2 عبر مسابقة وزارة المالية', url: '/university#ESI-KOLEA', icon: 'fas fa-landmark', specialty: 'مدارس عليا', keywords: ['ESI', 'ضرائب', 'جباية', 'fiscalité', 'impôts', 'مدرسة عليا للضرائب', 'قليعة', 'Kolea', 'مالية عامة', 'finances publiques', 'تدقيق جبائي', 'audit fiscal', 'DGI', 'مفتشية الضرائب', 'قانون مالي', 'محاسبة', 'جمارك', 'مستشار جبائي', 'conseiller fiscal', 'وزارة المالية', 'خزينة', 'SCF', 'جباية مؤسسات'] },

        // ── المدرسة الوطنية لحفظ الممتلكات الثقافية ──
        { title: 'المدرسة الوطنية العليا لحفظ الممتلكات الثقافية وترميمها – ENSRPC تيبازة', desc: 'ترميم وحفظ الآثار والمخطوطات والممتلكات الثقافية — دخول بمسابقة وطنية بعد الباك', url: '/university#ENSRPC', icon: 'fas fa-landmark', specialty: 'فنون وتراث', keywords: ['ENSRPC', 'حفظ الممتلكات الثقافية', 'ترميم', 'تراث', 'تيبازة', 'آثار', 'restoration', 'patrimoine', 'مخطوطات', 'متحف', 'OGEBC', 'فنون تشكيلية', 'أثري', 'patrimoine culturel', 'حفظ التراث'] },

        // ── الصحة والحماية الاجتماعية ──
        { title: 'الصحة والحماية الاجتماعية – Santé et Protection Sociale', desc: 'تسيير منظومة الرعاية والضمان — CNAS، CNR، مستشفيات، وزارة الصحة والتضامن الاجتماعي', url: '/university#HEALTH-SOC', icon: 'fas fa-heartbeat', specialty: 'اقتصاد وتسيير', keywords: ['الصحة والحماية الاجتماعية', 'ضمان اجتماعي', 'تأمين صحي', 'CNAS', 'CASNOS', 'CNR', 'مستشفى', 'تسيير صحي', 'santé', 'protection sociale', 'اقتصاد الصحة', 'تقاعد', 'حوادث العمل', 'HEALTH-SOC', 'إدارة مستشفيات', 'وزارة الصحة'] },

        // ── اقتصاد + علاقات دولية ──
        { title: 'إقتصاد + علاقات دولية – Double Diplôme', desc: 'الدبلوماسي الاقتصادي — تجارة دولية، جيوسياسية اقتصادية، بنوك دولية، شركات متعددة الجنسيات', url: '/university#ECO-IR', icon: 'fas fa-globe-americas', specialty: 'اقتصاد وعلوم سياسية', keywords: ['اقتصاد', 'علاقات دولية', 'دبلوماسية اقتصادية', 'تجارة دولية', 'مالية دولية', 'économie internationale', 'relations internationales', 'double diplôme', 'جيوسياسية', 'FMI', 'OMC', 'ZLECAF', 'ملحق اقتصادي', 'Risk Analyst', 'بنك دولي', 'صندوق النقد', 'ECO-IR', 'حروب تجارية', 'استثمار دولي'] },

        // ── إتصال + علاقات دولية ──
        { title: 'إتصال + علاقات دولية – Double Diplôme', desc: 'الدبلوماسية الإعلامية — علوم الإعلام والاتصال + علوم سياسية — Global PR، مراسل دولي، منظمات دولية', url: '/university#COMM-IR', icon: 'fas fa-satellite-dish', specialty: 'إعلام وعلوم سياسية', keywords: ['إتصال', 'علاقات دولية', 'إعلام', 'علوم سياسية', 'دبلوماسية إعلامية', 'communication', 'relations internationales', 'double diplôme', 'Global PR', 'attaché de presse', 'صحافة دولية', 'مراسل دولي', 'تسويق سياسي', 'اتصال أزماتي', 'منظمات دولية', 'COMM-IR', 'علاقات عامة دولية'] },

        // ── قانون عام + علاقات دولية ──
        { title: 'قانون عام + علاقات دولية – Double Diplôme', desc: 'بروفايل دبلوماسي-قانوني مزدوج — حقوق + علوم سياسية — دبلوماسية، منظمات دولية، مستشار قانوني', url: '/university#LAW-IR', icon: 'fas fa-balance-scale', specialty: 'حقوق وعلوم سياسية', keywords: ['قانون عام', 'علاقات دولية', 'دبلوماسية', 'حقوق', 'علوم سياسية', 'droit public', 'relations internationales', 'double diplôme', 'قانون دولي', 'دستور', 'قانون إداري', 'جيوسياسية', 'منظمات دولية', 'سفارة', 'قنصلية', 'تفاوض', 'NGO', 'أمم متحدة', 'LAW-IR'] },

        // ── العلوم الفلاحية ──
        { title: 'العلوم الفلاحية – Sciences Agronomiques', desc: 'فلاحة ذكية، تربة، نبات، حيوان، Smart Farming | ENSA الحراش – ESAS الوادي – ESA مستغانم', url: '/university#AGRO', icon: 'fas fa-seedling', specialty: 'agro', keywords: ['فلاحة', 'زراعة', 'AGRO', 'علوم فلاحية', 'agronome', 'مهندس زراعي', 'ENSA', 'ESAS', 'ESA', 'SNV', 'بيولوجيا', 'تربة', 'نبات', 'حيوان', 'بذور', 'ري تنقيط', 'جنوب صحراء', 'smart farming', 'pivot irrigation', 'DSA', 'INRA', 'آفات', 'حشرات'] },

        // ── الوقاية والأمن الصناعي ──
        { title: 'الوقاية والأمن الصناعي – HSE', desc: 'سلامة مهنية، مخاطر صناعية، QHSE، تلوث بيئي | وهران – باتنة – سكيكدة – ورقلة | سوناطراك', url: '/university#HSE', icon: 'fas fa-hard-hat', specialty: 'hse', keywords: ['HSE', 'وقاية', 'أمن صناعي', 'سلامة مهنية', 'QHSE', 'مخاطر صناعية', 'سوناطراك', 'نفطال', 'مصافي بترول', 'حرائق', 'إخلاء', 'تلوث بيئي', 'ورقلة', 'سكيكدة', 'باتنة', 'وهران', 'MRI', 'HSST', 'GPE', 'SIE', 'صحة سلامة بيئة'] },

        // ── الهندسة الهيدروليكية والري ──
        { title: 'الهندسة الهيدروليكية والري – Hydraulique', desc: 'سدود، شبكات مياه، محطات تصفية، صرف صحي، GIS | ENSH البليدة (مهندس دولة) – وهران – بجاية', url: '/university#HYDRO', icon: 'fas fa-water', specialty: 'hydro', keywords: ['هيدروليك', 'ري', 'HYDRO', 'مياه', 'سدود', 'هيدرولوجيا', 'ADE', 'ONA', 'ENSH', 'محطات تصفية', 'شبكات قنوات', 'صرف صحي', 'فيضانات', 'GIS', 'WaterCAD', 'Epanet', 'ArcGIS', 'موارد مائية', 'مياه جوفية', 'VRD', 'hydraulique', 'irrigation'] },

        // ── الآلية والتحكم الآلي ──
        { title: 'الآلية والتحكم الآلي – Automatique', desc: 'أتمتة، PLC، روبوتيك، خطوط إنتاج ذكية، Embedded Systems | بومرداس H22 (MCIL) – INELEC – Polytechnique', url: '/university#AUTO', icon: 'fas fa-cogs', specialty: 'auto', keywords: ['آلية', 'تحكم آلي', 'automatique', 'AUTO', 'PLC', 'روبوتيك', 'أتمتة', 'بومرداس', 'MCIL', 'INELEC', 'خطوط إنتاج', 'مصانع ذكية', 'embedded systems', 'سوناطراك', 'سونلغاز', 'Siemens', 'Schneider', 'IoT', 'ladder', 'SCADA'] },

        // ── الكهروتقني ──
        { title: 'الكهروتقني – Électrotechnique', desc: 'طاقة كهربائية، آلات، شبكات، طاقات متجددة، أتمتة صناعية | INELEC بومرداس – البليدة – سطيف – قسنطينة', url: '/university#ELECTRO', icon: 'fas fa-bolt', specialty: 'electro', keywords: ['كهروتقني', 'électrotechnique', 'ELECTRO', 'كهرباء', 'طاقة', 'INELEC', 'سونلغاز', 'سوناطراك', 'محطات توليد', 'أتمتة', 'طاقات متجددة', 'شبكات كهربائية', 'آلات كهربائية', 'PLC', 'SCADA', 'صناعة'] },

        // ── الاتصالات السلكية واللاسلكية ──
        { title: 'الاتصالات السلكية واللاسلكية – Télécommunications', desc: 'شبكات 5G، ألياف بصرية، معالجة إشارة، أمن شبكات | قالمة – USTHB – INTTIC وهران', url: '/university#TELECOM', icon: 'fas fa-broadcast-tower', specialty: 'telecom', keywords: ['اتصالات', 'تليكوم', 'TELECOM', 'سلكية لاسلكية', '5G', 'fibre optique', 'ألياف بصرية', 'INTTIC', 'USTHB', 'قالمة', 'أم البواقي', 'معالجة إشارة', 'شبكات', 'تشفير', 'أمن شبكات', 'IoT', 'هندسة اتصالات'] },

        // ── علوم البيئة والمحيط ──
        { title: 'علوم البيئة والمحيط – Environmental Sciences', desc: 'بيئة، تلوث، إيكولوجيا، دراسات أثر بيئي، Green Jobs | قسنطينة 1 (الإخوة منتوري)', url: '/university#ENV-SCI', icon: 'fas fa-leaf', specialty: 'env-sci', keywords: ['علوم البيئة', 'بيئة', 'ENV-SCI', 'تلوث', 'SNV', 'إيكولوجيا', 'قسنطينة', 'green jobs', 'أثر بيئي', 'استصلاح', 'تربة', 'هواء', 'ماء', 'محيط'] },

        // ── مهن المدينة ──
        { title: 'مهن المدينة – Métiers de la Ville', desc: 'تسيير وإشراف حضري ميداني — بناء مدن، شبكات، GIS، مشاريع عمرانية | تلمسان ISTA – بسكرة – باتنة', url: '/university#CITY-JOBS', icon: 'fas fa-city', specialty: 'city-jobs', keywords: ['مهن المدينة', 'métiers de la ville', 'CITY-JOBS', 'تسيير حضري', 'ورشة', 'GIS', 'ISTA', 'تلمسان', 'هندسة عمرانية', 'مقاولات', 'تطوير عقاري', 'تعمير', 'بناء'] },

        // ── إنتاج وتصميم رقمي وصناعة المحتوى ──
        { title: 'إنتاج وتصميم رقمي – صناعة المحتوى الرقمي | Digital Content Production', desc: 'تخصص يجمع التصميم الغرافيكي والمونتاج وخوارزميات السوشل ميديا لصناعة محتوى رقمي احترافي', url: '/university#DIGITAL-PROD', icon: 'fas fa-photo-video', specialty: 'digital-prod', keywords: ['إنتاج رقمي', 'تصميم رقمي', 'محتوى رقمي', 'digital content', 'content creator', 'graphic design', 'motion graphics', 'montage', 'reels', 'tiktok', 'youtube', 'social media', 'SEO', 'UI UX', 'photoshop', 'after effects', 'premiere', 'freelancing', 'الجزائر 3', 'قسنطينة 3', 'وهران 1', 'DIGITAL-PROD'] },

        // ── ممثل محترف وكاتب مسرحي ──
        { title: 'ممثل محترف وكاتب مسرحي – Acting & Playwriting', desc: 'تخصص فني مزدوج يجمع بين التمثيل الاحترافي والكتابة الدرامية المسرحية فوق الخشبة وخلف الكاميرا', url: '/university#THEATER', icon: 'fas fa-theater-masks', specialty: 'theater', keywords: ['تمثيل', 'مسرح', 'كتابة مسرحية', 'acting', 'playwriting', 'فنون عرض', 'دراما', 'ارتجال', 'improvisation', 'دبلجة', 'voice acting', 'ISMACS', 'وهران 1', 'مستغانم', 'باتنة 1', 'سيناريو', 'سينما', 'THEATER'] },

        // ── متحكم في الأداء الموسيقي والإبداع الفني ──
        { title: 'متحكم في الأداء الموسيقي والإبداع الفني – Musical Performance & Artistic Direction', desc: 'تخصص نخبوي يصنع قادة الأوركسترا والمخرجين الموسيقيين والمديرين الإبداعيين للمهرجانات والأوبرا', url: '/university#MUSIC-PERF', icon: 'fas fa-music', specialty: 'music-perf', keywords: ['موسيقى', 'أداء موسيقي', 'أوركسترا', 'مايسترو', 'توزيع موسيقي', 'هارموني', 'musical performance', 'artistic direction', 'هندسة صوتية', 'MAO', 'Pro Tools', 'مهرجان', 'أوبرا', 'INSM', 'ISMACS', 'مستغانم', 'تلمسان', 'MUSIC-PERF'] },

        // ── كتابة السيناريو ──
        { title: 'كتابة السيناريو – Screenwriting / Creative Writing', desc: 'تخصص فني إبداعي لتعلم كتابة النصوص السينمائية والدرامية من بناء الحبكة إلى الحوار والشخصيات', url: '/university#SCENARIO', icon: 'fas fa-pen-fancy', specialty: 'scenario', keywords: ['سيناريو', 'كتابة إبداعية', 'screenwriting', 'سيناريست', 'مسلسل', 'فيلم', 'حوار', 'قصة', 'دراما', 'كوميديا', 'خيال علمي', 'adaptation', 'narrative design', 'ISMACS', 'فنون درامية', 'وهران 1', 'باتنة 1', 'مستغانم', 'SCENARIO'] },

        // ── مصمم ثلاثي الأبعاد ومؤثرات خاصة ──
        { title: 'مصمم ثلاثي الأبعاد – مؤثرات خاصة | 3D Design & VFX', desc: 'تخصص إبداعي تكنولوجي لتصميم المجسمات الرقمية والمؤثرات البصرية للسينما والإعلانات والألعاب', url: '/university#3D-DESIGN', icon: 'fas fa-cube', specialty: '3d-design', keywords: ['3D', 'VFX', 'مصمم', 'ثلاثي الأبعاد', 'مؤثرات خاصة', 'blender', 'maya', 'modeling', 'animation', 'compositing', 'unreal engine', 'unity', 'سينما', 'إعلانات', 'ألعاب فيديو', 'gaming', 'freelancing', 'showreel', 'ISMACS', 'فنون جميلة', '3D-DESIGN'] },

        // ── علم الاجتماع الترفيه والأسفار ──
        { title: 'علم الاجتماع الترفيه والأسفار – Sociology of Leisure & Travel', desc: 'تخصص يدرس سلوك السواح وصناعة الترفيه والسياحة من منظور سوسيولوجي تطبيقي', url: '/university#SOC-LEISURE', icon: 'fas fa-umbrella-beach', specialty: 'soc-leisure', keywords: ['علم اجتماع', 'ترفيه', 'أسفار', 'سياحة', 'sociology', 'leisure', 'travel', 'camping', 'سواح', 'وقت فراغ', 'فندقة', 'tour operator', 'trip planner', 'تنشيط', 'animation', 'بيوت شباب', 'مخيمات', 'الجزائر 2', 'مستغانم', 'وهران 2', 'بسكرة', 'SOC-LEISURE'] },

        // ── التاريخ والبيانات الضخمة ──
        { title: 'التاريخ والبيانات الضخمة – History & Big Data', desc: 'تخصص هجين يجمع بين علم التاريخ والأرشيف وتقنيات البيانات الضخمة لرقمنة الذاكرة الوطنية', url: '/university#HISTORY-DATA', icon: 'fas fa-database', specialty: 'history-data', keywords: ['تاريخ', 'بيانات ضخمة', 'big data', 'history', 'أرشيف رقمي', 'مخطوطات', 'ذاكرة وطنية', 'رقمنة', 'digital historian', 'digital humanities', 'GIS', 'text mining', 'علوم إنسانية', 'أرشيف وطني', 'وزارة المجاهدين', 'وزارة الثقافة', 'متحف', 'الجزائر 2', 'قسنطينة 2', 'وهران 1', 'HISTORY-DATA'] },

        // ── الإعلام والاتصال الصحي ──
        { title: 'الإعلام والاتصال الصحي – Health Communication', desc: 'تخصص يجمع الإعلام والاتصال مع القطاع الصحي لتصميم حملات توعية وتسيير أزمات صحية إعلامية', url: '/university#HEALTH-COMM', icon: 'fas fa-stethoscope', specialty: 'health-comm', keywords: ['إعلام صحي', 'اتصال صحي', 'health communication', 'حملة توعية', 'صحافة طبية', 'وزارة الصحة', 'مستشفى', 'أدوية', 'اتصال أزمات', 'medical marketing', 'health journalist', 'توعية صحية', 'إشاعات طبية', 'جامعة الجزائر 3', 'قسنطينة 3', 'وهران 1', 'HEALTH-COMM'] },

        // ── التفاوض والتكنولوجيا المالية ──
        { title: 'التفاوض والتكنولوجيا المالية – Negotiation & FinTech', desc: 'Smart Fusion — FinTech، دفع إلكتروني، تفاوض تجاري، BizDev، بنوك رقمية، Startups مالية', url: '/university#FINTECH', icon: 'fas fa-mobile-alt', specialty: 'مالية وتكنولوجيا', keywords: ['التفاوض', 'التكنولوجيا المالية', 'fintech', 'negotiation', 'FINTECH', 'e-payment', 'baridimob', 'blockchain', 'mobile money', 'دفع إلكتروني', 'بنك رقمي', 'تمويل جماعي', 'digital banking', 'bizdev', 'business development', 'إقناع', 'صفقات', 'شركات ناشئة مالية', 'stripe', 'paypal', 'الجزائر 3', 'وهران 2', 'قسنطينة 2', 'جيزي', 'أوريدو', 'موبيليس', 'IOB', 'امتثال مالي', 'تأمين ذكي', 'startup'] },

        // ── التداول والأسواق المالية ──
        { title: 'التداول والأسواق المالية – Trading & Financial Markets', desc: 'بورصة، Forex، أسهم، تحليل فني وأساسي، محافظ مالية، Broker، Risk Manager — تسيير واقتصاد', url: '/university#TRADING', icon: 'fas fa-chart-bar', specialty: 'مالية وأسواق', keywords: ['التداول', 'الأسواق المالية', 'trading', 'financial markets', 'TRADING', 'بورصة', 'forex', 'أسهم', 'سندات', 'تحليل فني', 'تحليل أساسي', 'technical analysis', 'fundamental analysis', 'portfolio management', 'محافظ مالية', 'risk manager', 'broker', 'وسيط مالي', 'هندسة مالية', 'options', 'futures', 'prop trading', 'الجزائر 3', 'وهران 2', 'قسنطينة 2', 'EHEC', 'ESC', 'بنك', 'استثمار', 'ذهب', 'بترول', 'عملات', 'صندوق استثمار', 'financial english', 'رياضيات مالية'] },

        // ── الإدارة الإلكترونية للأعمال ──
        { title: 'الإدارة الإلكترونية للأعمال – E-Business / E-Management', desc: 'الـ E-Manager — تجارة إلكترونية، ERP، Agile، تحول رقمي، Startups، شركات خاصة — تسيير واقتصاد', url: '/university#E-BIZ', icon: 'fas fa-laptop', specialty: 'تسيير رقمي وتكنولوجيا', keywords: ['الإدارة الإلكترونية', 'e-business', 'e-management', 'E-BIZ', 'e-commerce', 'ERP', 'SAP', 'odoo', 'تجارة إلكترونية', 'تحول رقمي', 'digital transformation', 'agile', 'scrum', 'MIS', 'e-payment', 'remote work', 'الجزائر 3', 'وهران 2', 'قسنطينة 2', 'startups', 'تسيير رقمي', 'لوجيستيك', 'supply chain', 'e-commerce manager', 'consulting', 'paperless', 'تشريع رقمي'] },

        // ── الاتصال التسويقي وإدارة العلاقات مع الزبائن ──
        { title: 'الاتصال التسويقي وإدارة العلاقات مع الزبائن – MarCom & CRM', desc: 'تسويق رقمي، إشهار، CRM، Salesforce، وكالات إشهار، شركات — آداب ولغات وتسيير', url: '/university#MARKETING-COMM', icon: 'fas fa-handshake', specialty: 'إعلام واتصال وتسويق', keywords: ['الاتصال التسويقي', 'إدارة علاقات الزبائن', 'marcom', 'CRM', 'MARKETING-COMM', 'تسويق', 'إشهار', 'customer experience', 'account manager', 'salesforce', 'hubspot', 'consumer behavior', 'سلوك المستهلك', 'digital PR', 'علاقات عامة', 'call center', 'خدمة الزبائن', 'NPS', 'KPI', 'الجزائر 3', 'وهران', 'قسنطينة', 'سطيف', 'عنابة', 'آداب', 'لغات أجنبية', 'brand', 'تجربة الزبائن', 'e-commerce', 'after-sales'] },

        // ── إدارة نظم المعلومات الصحية ──
        { title: 'إدارة نظم المعلومات الصحية – Health Information Systems Management', desc: 'المهندس الرقمي للسبيطار — EHR، أمن بيانات طبية، HealthTech، CNAS، وزارة الصحة', url: '/university#HEALTH-INFO', icon: 'fas fa-hospital-user', specialty: 'تسيير وإعلام آلي طبي', keywords: ['إدارة نظم المعلومات الصحية', 'health information systems', 'HEALTH-INFO', 'EHR', 'رقمنة صحة', 'digital health', 'ملفات طبية إلكترونية', 'أمن سيبراني طبي', 'biostatistics', 'healthtech', 'سبيطار', 'مستشفى', 'CNAS', 'CASNOS', 'بطاقة الشفاء', 'وزارة الصحة', 'الجزائر 3', 'قسنطينة 2', 'إدارة مستشفيات', 'CHU', 'health IT manager', 'تأمين صحي', 'بيانات ضخمة طبية'] },

        // ── التربية والنفس حركية لمرحلة الطفولة ──
        { title: 'التربية والنفس حركية لمرحلة الطفولة – Psychomotor Education & Early Childhood', desc: 'أخصائي نفس حركي — توحد، ADHD، روضة، مراكز التربية الخاصة، وزارة التضامن', url: '/university#CHILDHOOD', icon: 'fas fa-child', specialty: 'علوم التربية وعلم النفس', keywords: ['التربية النفس حركية', 'مرحلة الطفولة', 'psychomotricité', 'early childhood', 'CHILDHOOD', 'طفل', 'روضة', 'توحد', 'autism', 'ADHD', 'صعوبات تعلم', 'dyslexia', 'علم نفس الطفل', 'child psychology', 'نمو الطفل', 'بيداغوجيا', 'إعاقة', 'الجزائر 2', 'قسنطينة 2', 'وهران 2', 'سطيف 2', 'أرطفوني', 'orthophonie', 'تربية خاصة', 'وزارة التضامن', 'مركز نفسي بيداغوجي', 'إدماج'] },

        // ── دراسات وابتكار عمومي ──
        { title: 'دراسات وابتكار عمومي – Public Studies & Innovation', desc: 'عصرنة الدولة — حوكمة إلكترونية، سياسات عمومية، Design Thinking — وزارات، ولايات، Think Tanks', url: '/university#PUBLIC-INNOV', icon: 'fas fa-city', specialty: 'علوم سياسية وحوكمة', keywords: ['دراسات عمومية', 'ابتكار عمومي', 'public studies', 'public innovation', 'PUBLIC-INNOV', 'حوكمة', 'رقمنة', 'e-government', 'سياسات عمومية', 'design thinking', 'تحول رقمي', 'عصرنة الإدارة', 'علوم سياسية', 'think tank', 'مستشار استراتيجي', 'الجزائر 3', 'قسنطينة 3', 'وهران 2', 'وزارة', 'بلدية', 'ولاية', 'إطار سامي', 'consulting', 'بيانات ضخمة', 'تسيير مشاريع عمومية', 'مرفق عام'] },

        // ── السينما والميديا الرقمية ──
        { title: 'السينما والميديا الرقمية – Cinema & Digital Media', desc: 'إنتاج سمعي بصري رقمي — مونتاج، إخراج، سيناريو، يوتيوب، Netflix — كليات الإعلام والاتصال', url: '/university#CINEMA-MEDIA', icon: 'fas fa-film', specialty: 'إعلام واتصال وفنون', keywords: ['السينما', 'الميديا الرقمية', 'cinema', 'digital media', 'CINEMA-MEDIA', 'مونتاج', 'إخراج', 'سيناريو', 'video editing', 'adobe premiere', 'davinci resolve', 'سمعي بصري', 'audiovisuel', 'يوتيوب', 'netflix', 'streaming', 'فيلم قصير', 'وثائقي', 'إعلام واتصال', 'الجزائر 3', 'قسنطينة 3', 'وهران 1', 'in-house video', 'freelance', 'portfolio', 'sound design', 'storytelling', 'صناعة محتوى', 'كاميرا', 'DSLR', 'إشهار'] },

        // ── الاتصال السياحي والترويج للأقاليم ──
        { title: 'الاتصال السياحي والترويج للأقاليم – Tourism Communication & Territorial Branding', desc: 'مسوق الأقاليم — سياحة، تراث، تسويق إقليمي، ONT، مديريات السياحة — آداب ولغات أجنبية', url: '/university#COMM-TOURISM', icon: 'fas fa-map-marked-alt', specialty: 'إعلام واتصال وسياحة', keywords: ['الاتصال السياحي', 'الترويج للأقاليم', 'tourism communication', 'territorial branding', 'COMM-TOURISM', 'سياحة', 'تسويق إقليمي', 'marketing territorial', 'ديوان السياحة', 'ONT', 'تراث', 'جغرافية السياحة', 'فيديو ترويجي', 'vlogging', 'علاقات عامة', 'تيبازة', 'مستغانم', 'بسكرة', 'صحراء', 'آثار', 'tour operator', 'فندقة', 'استثمار سياحي', 'آداب', 'لغات أجنبية', 'الجزائر 3'] },

        // ── الاتصال الرقمي وإدارة الأعمال ──
        { title: 'الاتصال الرقمي وإدارة الأعمال – Digital Communication & Business Administration', desc: 'بروفايل Digital Manager يجمع بين الإعلام الرقمي وتسيير الأعمال — Startups، وكالات إشهار، Brand Manager', url: '/university#DIGITAL-BIZ', icon: 'fas fa-laptop-code', specialty: 'إعلام واتصال وتسيير', keywords: ['الاتصال الرقمي', 'إدارة الأعمال', 'digital communication', 'business administration', 'DIGITAL-BIZ', 'سوشل ميديا', 'تسويق رقمي', 'digital marketing', 'brand manager', 'growth hacker', 'SEO', 'copywriting', 'تحليل بيانات', 'analytics', 'إدارة مشاريع رقمية', 'digital project management', 'الجزائر 3', 'وهران 2', 'قسنطينة 2', 'سمعة رقمية', 'digital reputation', 'startup', 'وكالة إشهار', 'اتصال مؤسساتي', 'e-business', 'e-management', 'أمن سيبراني'] },

        // ── إدارة المطارات والعبور ──
        { title: 'إدارة المطارات والعبور – Management Aéroportuaire', desc: 'تخصص لطلبة الآداب واللغات — لوجيستيك جوي، عبور، جمارك، شحن جوي', url: '/university#AEROPORT', icon: 'fas fa-plane', specialty: 'اقتصاد وتسيير', keywords: ['إدارة المطارات', 'management aéroportuaire', 'transit', 'عبور', 'طيران', 'aviation', 'لوجيستيك جوي', 'شحن جوي', 'fret', 'EGSA', 'ground handling', 'آداب', 'لغات أجنبية', 'جمارك', 'douane', 'خطوط جوية', 'مطار', 'aéroport', 'aviation english', 'supply chain', 'courier', 'freight', 'استيراد تصدير'] },
    ];
