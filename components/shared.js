    ...
    overlay.innerHTML = `
        <div class="welcome-announcement-card modal-version">
            ...
            <div class="welcome-badge-pill" style="background: linear-gradient(135deg, #ff6b1a, #e8420e); color: #fff; box-shadow: 0 4px 14px rgba(232,66,14,0.35); border: none;">
                <i class="fas fa-star"></i> جديد القناة والمنصة
            </div>
            <h3>سلسلة تجارب المتفوقين</h3>
            <p style="margin-bottom: 1.2rem; line-height: 1.7; color: #334155;">أطلقنا سلسلة جديدة وحصرية تحت عنوان <b>«تجارب المتفوقين»</b>، نستضيف فيها نخبة من أوائل بكالوريا الجزائر الحاصلين على تقدير ممتاز بمعدلات تفوق 18 و19 من مختلف الشعب.<br><br>يشاركونكم خلاصة مسيرتهم، خططهم الأسبوعية، كيفية تسيير الضغط، ونصائح ذهبية لتصنعوا تميزكم الخاص. تصفحوا التجارب الآن عبر الموقع أو تابعوها عبر قناتنا على التلغرام!</p>
            <div class="card-cta-group" style="display: flex; flex-direction: column; gap: 10px; width: 100%;">
                <a href="/experiences" class="card-cta-btn card-cta-web" style="display: inline-flex; align-items: center; justify-content: center; gap: 8px; width: 100%; font-size: 1.02rem; font-weight: 800; padding: 12px 24px; background: #ffffff; color: #1a3a8f; border: 1.5px solid rgba(26, 58, 143, 0.22); border-radius: 999px; box-shadow: 0 4px 14px rgba(0, 0, 0, 0.06); text-decoration: none; transition: transform 0.2s ease, box-shadow 0.2s ease;">
                    <i class="fas fa-medal" style="color: #ff6b35;"></i> تصفح التجارب على الموقع
                </a>
                <a href="https://t.me/islembacdz" target="_blank" rel="noopener noreferrer" class="card-cta-btn card-cta-telegram" style="display: inline-flex; align-items: center; justify-content: center; gap: 8px; width: 100%; font-size: 1.02rem; font-weight: 800; padding: 12px 24px; background: #2AABEE; color: #fff; border: none; border-radius: 999px; box-shadow: 0 4px 15px rgba(42,171,238,0.4); text-decoration: none; transition: transform 0.2s ease, box-shadow 0.2s ease;">
...
function setupSearch() {
    ...
    const navSearchData = [
        ...
        { title: 'مواد التكنولوجيا', desc: 'هندسة مدنية، كهربائية، ميكانيكية وطرائق', url: '/resources/tech', icon: 'fas fa-microchip', specialty: null, keywords: ['تكنولوجيا', 'تقني', 'هندسة', 'تقني رياضي', 'شعبة تقني رياضي', 'تكنو رياضي', 'شعبة تقني رياضي', 'التقني الرياضي'] },
        ...
        { title: 'أرشيف تقني رياضي (2008-2023)', desc: 'تجميعية حوليات بكالوريا شعبة تقني رياضي من 2008 إلى 2023', url: '/topics/bac-archives/tech', icon: 'fas fa-drafting-compass', specialty: 'تقني رياضي', keywords: ['أرشيف تقني رياضي', 'حوليات تقني رياضي', 'تقني رياضي', 'تجميعية تقني رياضي'] },
        ...
        { title: 'أرشيف الرياضيات — تقني رياضي', desc: 'تجميعية حوليات الرياضيات لشعبة تقني رياضي في البكالوريا الجزائرية من 2008 إلى 2023', url: '/topics/bac-archives/tech/math', icon: 'fas fa-calculator', specialty: 'تقني رياضي', keywords: ['حوليات رياضيات تقني رياضي', 'رياضيات تقني رياضي'] },
        { title: 'أرشيف العلوم الفيزيائية — تقني رياضي', desc: 'تجميعية حوليات العلوم الفيزيائية لشعبة تقني رياضي في البكالوريا الجزائرية من 2008 إلى 2023', url: '/topics/bac-archives/tech/physique', icon: 'fas fa-atom', specialty: 'تقني رياضي', keywords: ['حوليات فيزياء تقني رياضي', 'فيزياء تقني رياضي'] },
        { title: 'أرشيف الهندسة المدنية — تقني رياضي', desc: 'تجميعية حوليات الهندسة المدنية لشعبة تقني رياضي في البكالوريا الجزائرية من 2008 إلى 2023', url: '/topics/bac-archives/tech/civil', icon: 'fas fa-hard-hat', specialty: 'تقني رياضي', keywords: ['حوليات هندسة مدنية', 'أرشيف مدني باك'] },
        { title: 'أرشيف الهندسة الكهربائية — تقني رياضي', desc: 'تجميعية حوليات الهندسة الكهربائية لشعبة تقني رياضي في البكالوريا الجزائرية من 2008 إلى 2023', url: '/topics/bac-archives/tech/electrique', icon: 'fas fa-bolt', specialty: 'تقني رياضي', keywords: ['حوليات هندسة كهربائية', 'أرشيف كهرباء باك'] },
        { title: 'أرشيف الهندسة الميكانيكية — تقني رياضي', desc: 'تجميعية حوليات الهندسة الميكانيكية لشعبة تقني رياضي في البكالوريا الجزائرية من 2008 إلى 2023', url: '/topics/bac-archives/tech/mecanique', icon: 'fas fa-tools', specialty: 'تقني رياضي', keywords: ['حوليات هندسة ميكانيكية', 'أرشيف ميكانيك باك'] },
        { title: 'أرشيف هندسة الطرائق — تقني رياضي', desc: 'تجميعية حوليات هندسة الطرائق لشعبة تقني رياضي في البكالوريا الجزائرية من 2008 إلى 2023', url: '/topics/bac-archives/tech/routes', icon: 'fas fa-road', specialty: 'تقني رياضي', keywords: ['حوليات طرائق', 'أرشيف طرائق باك'] },
        { title: 'أرشيف اللغة العربية — تقني رياضي', desc: 'تجميعية حوليات اللغة العربية لشعبة تقني رياضي في البكالوريا الجزائرية من 2008 إلى 2023', url: '/topics/bac-archives/tech/arabe', icon: 'fas fa-language', specialty: 'تقني رياضي', keywords: ['حوليات عربية تقني رياضي'] },
        { title: 'أرشيف اللغة الفرنسية — تقني رياضي', desc: 'تجميعية حوليات اللغة الفرنسية لشعبة تقني رياضي في البكالوريا الجزائرية من 2008 إلى 2023', url: '/topics/bac-archives/tech/francais', icon: 'fas fa-flag', specialty: 'تقني رياضي', keywords: ['حوليات فرنسية تقني رياضي'] },
        { title: 'أرشيف اللغة الإنجليزية — تقني رياضي', desc: 'تجميعية حوليات اللغة الإنجليزية لشعبة تقني رياضي في البكالوريا الجزائرية من 2008 إلى 2023', url: '/topics/bac-archives/tech/anglais', icon: 'fas fa-globe-americas', specialty: 'تقني رياضي', keywords: ['حوليات إنجليزية تقني رياضي'] },
        { title: 'أرشيف العلوم الإسلامية — تقني رياضي', desc: 'تجميعية حوليات العلوم الإسلامية لشعبة تقني رياضي في البكالوريا الجزائرية من 2008 إلى 2023', url: '/topics/bac-archives/tech/islamique', icon: 'fas fa-mosque', specialty: 'تقني رياضي', keywords: ['حوليات إسلاميات تقني رياضي'] },
        { title: 'أرشيف التاريخ والجغرافيا — تقني رياضي', desc: 'تجميعية حوليات التاريخ والجغرافيا لشعبة تقني رياضي في البكالوريا الجزائرية من 2008 إلى 2023', url: '/topics/bac-archives/tech/histoire-geo', icon: 'fas fa-landmark', specialty: 'تقني رياضي', keywords: ['حوليات تاريخ تقني رياضي'] },
        { title: 'أرشيف الفلسفة — تقني رياضي', desc: 'تجميعية حوليات الفلسفة لشعبة تقني رياضي في البكالوريا الجزائرية من 2008 إلى 2023', url: '/topics/bac-archives/tech/philosophie', icon: 'fas fa-brain', specialty: 'تقني رياضي', keywords: ['حوليات فلسفة تقني رياضي'] },
        { title: 'أرشيف الأمازيغية — تقني رياضي', desc: 'تجميعية حوليات اللغة الأمازيغية لشعبة تقني رياضي في البكالوريا الجزائرية من 2008 إلى 2023', url: '/topics/bac-archives/tech/tamazight', icon: 'fas fa-font', specialty: 'تقني رياضي', keywords: ['حوليات أمازيغية تقني رياضي'] },
        ...
        { title: 'تصحيح 2026 — هندسة', desc: 'حلول بكالوريا 2026 شعبة تقني رياضي', url: '/bac-2026/tech', icon: 'fas fa-check-double', specialty: 'تقني رياضي', keywords: ['تصحيح 2026', 'بكالوريا 2026', 'هندسة', 'تقني', 'tech 2026'] },
        ...
        { title: 'تصحيح 2025 — هندسة', desc: 'حلول بكالوريا 2025 شعبة تقني رياضي', url: '/topics/bac-2025/tech', icon: 'fas fa-check-double', specialty: 'تقني رياضي', keywords: ['تصحيح 2025', 'بكالوريا 2025', 'هندسة', 'تقني', 'tech 2025'] },
        ...
        { title: 'تصحيح 2024 — هندسة', desc: 'حلول بكالوريا 2024 شعبة تقني رياضي', url: '/topics/bac-2024/tech', icon: 'fas fa-check-double', specialty: 'تقني رياضي', keywords: ['تصحيح 2024', 'بكالوريا 2024', 'هندسة', 'تقني', 'tech 2024'] },
        ...
        { title: 'تجارب المتفوقين', desc: 'تجارب ونصائح أوائل البكالوريا نظاميون وأحرار لجميع الشعب', url: '/experiences', icon: 'fas fa-user-graduate', specialty: null, keywords: ['تجارب المتفوقين', 'تجارب', 'متفوقين', 'أوائل البكالوريا', 'نظامي', 'حر', 'أمين بداد', 'يونس', 'تجارب الباك', 'نصائح المتفوقين', 'experiences'] },
        ...
        { title: 'العد التنازلي لبكالوريا 2027', desc: 'كم تبقى على امتحانات بكالوريا 2027؟', url: '/tools/countdown', icon: 'fas fa-hourglass-half', specialty: null, keywords: ['العد التنازلي', 'الوقت المتبقي', 'بكالوريا 2027', 'باك 2027', 'مؤقت', 'timer', 'قداه بقى', 'متبقي'] },
        ...
        { title: 'الرياضيات', desc: 'دروس، ملخصات وتمارين', url: '/resources/tech/math', icon: 'fas fa-calculator', specialty: 'تقني رياضي', keywords: ['رياضيات', 'ملخصات', 'دروس', 'تمارين'] },
        ...
        // ── TECHNOLOGY TYPES ───────────────────────────────────────────────
        { title: 'التكنولوجيا — تقني رياضي', desc: 'موارد مادة التكنولوجيا: هندسة مدنية، كهربائية، ميكانيكية وطرائق', url: '/resources/tech/technology', icon: 'fas fa-hard-hat', specialty: 'تقني رياضي', keywords: ['تكنولوجيا', 'التكنولوجيا', 'هندسة مدنية', 'هندسة كهربائية', 'هندسة ميكانيكية', 'هندسة طرائق'] },
        { title: 'الهندسة المدنية', desc: 'مقاومة المواد، التربة والمنشآت', url: '/resources/tech/civil-engineering', icon: 'fas fa-hard-hat', specialty: 'تقني رياضي', keywords: ['الهندسة المدنية', 'مدني', 'مقاومة المواد', 'التربة', 'خرسانة', 'هندسة مدنية'] },
        { title: 'الهندسة الكهربائية', desc: 'الأنظمة الكهربائية والإلكترونية', url: '/resources/tech/electrical-engineering', icon: 'fas fa-plug', specialty: 'تقني رياضي', keywords: ['الهندسة الكهربائية', 'كهربائية', 'إلكترونية', 'دوائر', 'هندسة كهربائية'] },
        { title: 'الهندسة الميكانيكية', desc: 'الأنظمة الميكانيكية وتحليل الحركات', url: '/resources/tech/mechanical-engineering', icon: 'fas fa-cog', specialty: 'تقني رياضي', keywords: ['الهندسة الميكانيكية', 'ميكانيكية', 'الأنظمة', 'هندسة ميكانيكية'] },
        { title: 'هندسة الطرائق', desc: 'تصميم الطرق والمشاريع الإنشائية', url: '/resources/tech/road-engineering', icon: 'fas fa-road', specialty: 'تقني رياضي', keywords: ['هندسة الطرائق', 'طرائق', 'الطرق', 'إنشائية'] },
        ...
        { title: 'شعبة تقني رياضي', desc: 'جميع مواد وموارد شعبة تقني رياضي', url: '/resources/tech', icon: 'fas fa-microchip', specialty: 'تقني رياضي', keywords: ['تقني رياضي', 'شعبة تقني رياضي', 'تكنو رياضي', 'التقني الرياضي', 'تكنولوجيا'] },
