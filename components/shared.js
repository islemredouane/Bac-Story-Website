...
function setupSearch() {
    ...
    const navSearchData = [
        ...
        { title: 'القانون الجنائي والعلوم الجنائية', desc: 'ماستر جنائي — محاماة، قضاء، إجرام وجرائم مستحدثة', url: '/university.html#PENAL', icon: 'fas fa-balance-scale', specialty: 'جامعة LMD', keywords: ['جنائي', 'قانون جنائي', 'droit pénal', 'PENAL', 'إجرام', 'criminologie', 'جنايات', 'محاماة', 'قاضي', 'وكيل جمهورية', 'cybercrime', 'جرائم إلكترونية', 'ESM'] },
        { title: 'علم الإجرام والسياسة الجنائية', desc: 'ماستر criminologie — تحليل جنائي، سياسة وقاية، تأهيل ومؤسسات عقابية', url: '/university.html#CRIMINOLOGIE', icon: 'fas fa-user-secret', specialty: 'جامعة LMD', keywords: ['علم إجرام', 'criminologie', 'CRIMINOLOGIE', 'سياسة جنائية', 'علم نفس جنائي', 'علم اجتماع جنائي', 'victimologie', 'علم ضحية', 'مؤسسات عقابية', 'سجون', 'تحليل جنائي', 'أمن وطني', 'درك'] },
        { title: 'الأدلة الجنائية والشرطة العلمية', desc: 'مسار المخبر الجنائي — DNA، بصمات، balistique، أدلة رقمية، INCC', url: '/university.html#FORENSIQUE', icon: 'fas fa-microscope', specialty: 'أمن وطني / درك', keywords: ['شرطة علمية', 'أدلة جنائية', 'FORENSIQUE', 'police scientifique', 'sciences forensiques', 'DNA', 'بصمات', 'مسرح جريمة', 'balistique', 'INCC', 'بوشاوي', 'مخبر جنائي', 'تزوير وثائق', 'جريمة إلكترونية رقمية'] },
        { title: 'الأكاديمية العسكرية بشرشال', desc: 'EMIA شرشال — ضابط مهندس، هندسة تقنية + تكوين عسكري، مضمون في الجيش', url: '/university.html#CHERCHALL', icon: 'fas fa-shield-alt', specialty: 'وزارة الدفاع الوطني', keywords: ['شرشال', 'CHERCHALL', 'EMIA', 'أكاديمية عسكرية', 'académie militaire', 'ضابط مهندس', 'جيش وطني شعبي', 'وزارة دفاع', 'mdn', 'دفاع', 'تكوين عسكري', 'هندسة عسكرية', 'بكالوريا رياضيات عسكري'] },
        ...
        { title: 'ENA — الإدارة', desc: 'المدرسة الوطنية للإدارة — حيدرة — تكوين الإطارات السامية', url: '/university.html#ENA', icon: 'fas fa-landmark', specialty: 'مدارس عليا', keywords: ['ENA', 'ena', 'إدارة عامة', 'administration publique', 'حوكمة', 'وزارة', 'والي', 'إطارات دولة', 'fonctionnaire', 'حيدرة', 'مسابقة إدارة', 'الوظيف العمومي'] },
        { title: 'المدرسة العليا للقضاء — ESM', desc: 'تكوين القضاة والمدعين العامين — القليعة', url: '/university.html#ESM-JUSTICE', icon: 'fas fa-gavel', specialty: 'مدارس عليا', keywords: ['قضاء', 'قاضي', 'magistrature', 'محكمة', 'ESM', 'المدرسة العليا للقضاء', 'وكيل جمهورية', 'حكم', 'القليعة', 'وزارة العدل', 'justice', 'مسابقة قضاء'] },
        { title: 'ESSS — الضمان الاجتماعي', desc: 'المدرسة العليا للضمان الاجتماعي — بن عكنون — شراكة BIT/ILO', url: '/university.html#ESSS', icon: 'fas fa-hand-holding-heart', specialty: 'مدارس عليا', keywords: ['ESSS', 'esss', 'ضمان اجتماعي', 'sécurité sociale', 'CNAS', 'CASNOS', 'BIT', 'ILO', 'حماية اجتماعية', 'تأمين', 'بن عكنون', 'travail'] },
        { title: 'ENMAS — إدارة الصحة', desc: 'المدرسة العليا للمناجمنت وإدارة الصحة — برج البحري', url: '/university.html#ENMAS', icon: 'fas fa-hospital', specialty: 'مدارس عليا', keywords: ['ENMAS', 'enmas', 'إدارة صحة', 'management hospitalier', 'مستشفى', 'مدير مستشفى', 'صحة عامة', 'برج البحري', 'وزارة الصحة', 'hôpital'] },
        { title: 'IEDF — الجباية والجمارك', desc: 'معهد الاقتصاد الجبائي والجمركي — القليعة — مشترك جزائري تونسي', url: '/university.html#IEDF', icon: 'fas fa-receipt', specialty: 'مدارس عليا', keywords: ['IEDF', 'iedf', 'جباية', 'جمارك', 'fiscalité', 'douane', 'ضرائب', 'TVA', 'مفتش ضرائب', 'التجارة الخارجية', 'القليعة', 'مالية', 'impôts'] },
        { title: 'IDRI — الدبلوماسية', desc: 'معهد الدبلوماسية والعلاقات الدولية — بن عكنون — وزارة الخارجية', url: '/university.html#IDRI', icon: 'fas fa-globe-africa', specialty: 'مدارس عليا', keywords: ['IDRI', 'idri', 'دبلوماسية', 'علاقات دولية', 'سفير', 'دبلوماسي', 'وزارة الخارجية', 'MAE', 'سفارة', 'diplomatie', 'relations internationales', 'بن عكنون'] },
        { title: 'ESSP — العلوم السياسية', desc: 'المدرسة العليا للعلوم السياسية — بن عكنون — دراسات استراتيجية', url: '/university.html#ESSP', icon: 'fas fa-vote-yea', specialty: 'مدارس عليا', keywords: ['ESSP', 'essp', 'علوم سياسية', 'sciences politiques', 'دراسات استراتيجية', 'جيوسياسية', 'تحليل سياسي', 'بن عكنون', 'أمن', 'géopolitique'] },
        { title: 'ENSJSI — الصحافة والإعلام', desc: 'المدرسة الوطنية العليا للصحافة وعلوم الإعلام — بن عكنون', url: '/university.html#ENSJSI', icon: 'fas fa-newspaper', specialty: 'مدارس عليا', keywords: ['ENSJSI', 'ensjsi', 'صحافة', 'إعلام', 'journalisme', 'télévision', 'radio', 'reportage', 'صحفي', 'اتصال', 'médias', 'بودكاست', 'بن عكنون', 'تلفزيون'] },

        // ── اللغات الأجنبية – تخصصات فردية ──
        { title: 'ليسانس الإنجليزية – Anglais', desc: 'تخصص اللغة الإنجليزية — ترجمة، تدريس، شركات دولية، freelance', url: '/university.html#ANGLAIS', icon: 'fas fa-language', specialty: 'لغات أجنبية', keywords: ['anglais', 'إنجليزية', 'اللغة الإنجليزية', 'ليسانس إنجليزية', 'english', 'ESP', 'ترجمة إنجليزية', 'Fulbright', 'فريلانس', 'Fiverr', 'شركات دولية', 'ENS', 'phonetics', 'linguistics'] },
        { title: 'ليسانس الفرنسية – Français', desc: 'تخصص اللغة الفرنسية — أدب، إدارة، تعليم، صحافة', url: '/university.html#FRANCAIS', icon: 'fas fa-language', specialty: 'لغات أجنبية', keywords: ['français', 'فرنسية', 'اللغة الفرنسية', 'ليسانس فرنسية', 'littérature française', 'didactique', 'FLE', 'إدارة', 'صحافة', 'بنوك', 'grammaire', 'linguistique'] },
        { title: 'ليسانس الإسبانية – Espagnol', desc: 'تخصص اللغة الإسبانية — سياحة، استيراد تصدير، أمريكا لاتينية', url: '/university.html#ESPAGNOL', icon: 'fas fa-language', specialty: 'لغات أجنبية', keywords: ['espagnol', 'إسبانية', 'اللغة الإسبانية', 'ليسانس إسبانية', 'español', 'أمريكا لاتينية', 'سياحة', 'استيراد تصدير', 'ترجمة إسبانية', 'البليدة 2', 'وهران 2', 'قسنطينة 1', 'تلمسان', 'gramática'] },
        { title: 'ليسانس الألمانية – Allemand', desc: 'تخصص اللغة الألمانية — Ausbildung ألمانيا، شركات ألمانية، Goethe-Institut', url: '/university.html#ALLEMAND', icon: 'fas fa-language', specialty: 'لغات أجنبية', keywords: ['allemand', 'ألمانية', 'اللغة الألمانية', 'ليسانس ألمانية', 'Deutsch', 'Ausbildung', 'هجرة ألمانيا', 'Goethe-Institut', 'Siemens', 'BASF', 'Volkswagen', 'شركات ألمانية', 'Grammatik'] },
        { title: 'ليسانس الإيطالية – Italien', desc: 'تخصص اللغة الإيطالية — ENI، شراكة جزائرية إيطالية، ترجمة طاقة', url: '/university.html#ITALIEN', icon: 'fas fa-language', specialty: 'لغات أجنبية', keywords: ['italien', 'إيطالية', 'اللغة الإيطالية', 'ليسانس إيطالية', 'italiano', 'ENI', 'Saipem', 'Mattei Plan', 'طاقة إيطالية', 'ترجمة إيطالية', 'البليدة 2', 'Dante', 'Boccaccio'] },
        { title: 'ليسانس الروسية – Russe', desc: 'تخصص اللغة الروسية — دبلوماسية، Sonatrach-Gazprom، منح روسيا', url: '/university.html#RUSSE', icon: 'fas fa-language', specialty: 'لغات أجنبية', keywords: ['russe', 'روسية', 'اللغة الروسية', 'ليسانس روسية', 'Gazprom', 'Sonatrach', 'سفارة روسيا', 'منح روسيا', 'دبلوماسية', 'قسم اللغات الشرقية', 'Dostoevsky', 'Tolstoy', 'سيريلية'] },
        { title: 'ليسانس التركية – Turc', desc: 'تخصص اللغة التركية — Tosyali، Tayal، شركات تركية، أعلى توظيف', url: '/university.html#TURC', icon: 'fas fa-language', specialty: 'لغات أجنبية', keywords: ['turc', 'تركية', 'اللغة التركية', 'ليسانس تركية', 'Türkçe', 'Tosyali', 'Tayal', 'شركات تركية', 'يونس إمرة', 'Yunus Emre', 'استثمار تركي', 'سفارة تركيا', 'vowel harmony'] },
        { title: 'ليسانس الصينية – Chinois', desc: 'تخصص اللغة الصينية — Huawei، ZTE، موانئ، ترجمة دولة، منح الصين', url: '/university.html#CHINOIS', icon: 'fas fa-language', specialty: 'لغات أجنبية', keywords: ['chinois', 'صينية', 'اللغة الصينية', 'ليسانس صينية', 'Huawei', 'ZTE', 'COSCO', 'ميناء الحمدانية', 'منح الصين', 'Confucius', 'كونفوشيوس', 'HSK', 'Hanzi', 'Pinyin', 'ترجمة صينية'] },

        // ── ESAA ──
        { title: 'ESAA — إدارة الأعمال', desc: 'المدرسة العليا الجزائرية للأعمال — المحمدية — شهادة مزدوجة جزائرية فرنسية', url: '/university.html#ESAA', icon: 'fas fa-briefcase', specialty: 'مدارس عليا', keywords: ['ESAA', 'esaa', 'إدارة أعمال', 'تسيير', 'مالية', 'تسويق', 'شهادة مزدوجة', 'double diplôme', 'Kedge', 'Audencia', 'BNP Paribas', 'Big Four', 'KPMG', 'EY', 'TAGE', 'المحمدية', 'شراكة فرنسية', 'ريادة أعمال', 'محاسبة', 'Schneider', 'Unilever'] },

        // ── تخصصات اقتصاد وتسيير الجامعية ──
        { title: 'العلوم الاقتصادية – Sciences Éco', desc: 'تخصص اقتصاد كلي وجزئي — بنوك، وزارة المالية، مراكز بحوث', url: '/university.html#ECO', icon: 'fas fa-chart-line', specialty: 'اقتصاد وتسيير', keywords: ['علوم اقتصادية', 'اقتصاد', 'sciences économiques', 'microéconomie', 'macroéconomie', 'اقتصاد كلي', 'اقتصاد جزئي', 'اقتصاد نقدي', 'بنوك', 'بنك مركزي', 'سياسة نقدية', 'تضخم', 'وزارة المالية', 'SEGC', 'تحليل اقتصادي', 'اقتصاد دولي'] },
        { title: 'علوم التسيير – Sciences de Gestion', desc: 'تخصص إدارة وتسيير — محاسبة، موارد بشرية، تدقيق، مراقبة', url: '/university.html#GESTION', icon: 'fas fa-cogs', specialty: 'اقتصاد وتسيير', keywords: ['علوم التسيير', 'تسيير', 'sciences de gestion', 'management', 'محاسبة', 'comptabilité', 'موارد بشرية', 'GRH', 'تدقيق', 'audit', 'مراقبة التسيير', 'contrôle de gestion', 'مالية', 'CFO', 'ERP', 'SEGC', 'إدارة أعمال'] },
        { title: 'العلوم التجارية – Sciences Commerciales', desc: 'تخصص تسويق وتجارة دولية — لوجيستيك، استيراد تصدير، E-Commerce', url: '/university.html#COMMERCE', icon: 'fas fa-store', specialty: 'اقتصاد وتسيير', keywords: ['علوم تجارية', 'تجارية', 'sciences commerciales', 'تسويق', 'marketing', 'تجارة دولية', 'commerce international', 'لوجيستيك', 'supply chain', 'استيراد تصدير', 'import export', 'جمارك', 'e-commerce', 'تسويق رقمي', 'digital marketing', 'SEGC'] },

        // ── المدرسة العليا للضرائب ──
        { title: 'المدرسة العليا للضرائب – ESI قليعة', desc: 'مدرسة عليا للجباية والمالية العامة — دخول بعد Bac+2 عبر مسابقة وزارة المالية', url: '/university.html#ESI-KOLEA', icon: 'fas fa-landmark', specialty: 'مدارس عليا', keywords: ['ESI', 'ضرائب', 'جباية', 'fiscalité', 'impôts', 'مدرسة عليا للضرائب', 'قليعة', 'Kolea', 'مالية عامة', 'finances publiques', 'تدقيق جبائي', 'audit fiscal', 'DGI', 'مفتشية الضرائب', 'قانون مالي', 'محاسبة', 'جمارك', 'مستشار جبائي', 'conseiller fiscal', 'وزارة المالية', 'خزينة', 'SCF', 'جباية مؤسسات'] },
