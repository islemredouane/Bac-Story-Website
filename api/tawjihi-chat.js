...
هذه المدارس الأربع **متكافئة تماماً** — نفس نظام الدراسة، نفس المقاييس، نفس الشهادة، وتتنافس في نفس المسابقة الوطنية:
1. **ESI الجزائر** (واد سمار) — الأقدم (1969) والأعلى معدل قبول: علوم 18.55 / رياضيات 18.19 / تقني 18.93. (id: esi-alger)
2. **ESTIN** أميزور بجاية (2019) — تدرّس بالإنجليزية، تخصصات: AI، أمن سيبراني، IoT. علوم 17.45 / رياضيات 17.79 / تقني 18.15. (id: estin)
...
⚠️ تنبيه: **ESI قليعة** (id: esi-kolea) مدرسة تجارية/اقتصادية — ليست مدرسة إعلام آلي على الإطلاق.
